...
function updateHeader(){
  ...
  const pastHero=hero?currentY>hero.offsetHeight-80:currentY>20;
...
header.addEventListener('pointerup',()=>{if(matchMedia('(max-width: 759px)').matches&&window.scrollY>(hero?hero.offsetHeight-80:20))scheduleMobileHide(2200)});
