...
async function loadLanguage(lang){
  ...
  if(whatsapp){const text=getPath(messages,'booking.message');whatsapp.href=`https://wa.me/351934463513?text=${encodeURIComponent(text||'Olá, Miriam! Tudo bem? Vim pelo site da Rossini Lash Design e gostaria de saber mais sobre os serviços e horários disponíveis.')}`}
}
